...
Below are some notes on how to build Yody Core for Windows.

The options known to work for building Yody Core on Windows are:

* On Linux, using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Bionic 18.04 is required
and is the platform used to build the Yody Core Windows release binaries.
...
It's not possible to build the Yody Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the Yody Core source code).
