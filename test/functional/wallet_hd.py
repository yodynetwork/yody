...
from test_framework.yody import generatesynchronized, convert_btc_bech32_address_to_yody
...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        non_hd_add = convert_btc_bech32_address_to_yody('bcrt1qmevj8zfx0wdvp05cqwkmr6mxkfx60yezwjksmt')
