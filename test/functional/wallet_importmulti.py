...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [convert_btc_address_to_yody("2N7yv4p8G8yEaPddJxY41kPihnWvs39qCMf"), convert_btc_address_to_yody("2MsHxyb2JS3pAySeNUsJ7mNnurtpeenDzLA")] # hdkeypath=m/0'/0'/0' and 1'
        addresses += [convert_btc_bech32_address_to_yody("bcrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7scl8gn"), convert_btc_bech32_address_to_yody("bcrt1qfqeppuvj0ww98r6qghmdkj70tv8qpchehegrg8")] # wpkh subscripts corresponding to the above addresses
        ...
        self.test_importmulti(
            {
                "scriptPubKey": {"address": convert_btc_bech32_address_to_yody("bcrt1p0xlxvlhemja6c4dqv22uapctqupfhlxm9h8z3k2e72q4k9hcz7vqc8gma6")},
                "timestamp": "now",
            },
            success=False,
            error_code=-5,
