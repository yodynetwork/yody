...
from test_framework.yody import convert_btc_address_to_yody
...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mkHV1C6JLheLoUSSZYk7x3FH5tnx9bu7yc"), 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mipUSRmJAj2KrjSvsPQtnP8ynUon7FhpCR"), 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("n37dAGe6Mq1HGM9t4b6rFEEsDGq7Fcgfqg"), 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mqS9Rpg8nNLAzxFExsgFLCnzHBsoQ3PRM6"), 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mnTg5gVWr3rbhHaKjJv7EEEc76ZqHgSj4S"), 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mketCd6B9U9Uee1iCsppDJJBHfvi6U6ukC"), 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mj8zFzrbBcdaWXowCQ1oPZ4qioBVzLzAp7"), 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mfnKpKQEftniaoE1iXuMMePQU3PUpcNisA"), 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mou6cB1kaP1nNJM1sryW6YRwnd4shTbXYQ"), 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mtfUoUax9L4tzXARpw1oTGxWyoogp52KhJ"), 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mxp7w7j8S1Aq6L8StS2PqVvtt4HGxXEvdy"), 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress(convert_btc_address_to_yody("mpQ8rokAhp1TAtJQR6F6TaUmjAWkAWYYBq"), 16.384) # (m/1/1/1500)
