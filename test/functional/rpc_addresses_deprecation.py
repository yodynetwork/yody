...
class AddressesDeprecationTest(BitcoinTestFramework):
    ...
    def test_addresses_deprecation(self):
        ...
        assert_equal(script_pub_key['addresses'], [convert_btc_address_to_yody('mvKDK6D54HU8wQumJBLHY95eq5iHFqXSBz'), convert_btc_address_to_yody('mv3rHCQSwKp2BLSuMHD8uCS32LW5xiNAA5'), convert_btc_address_to_yody('mirrsyhAQYzo5CwVhcaYJKwUJu1WJRCRJe')])
