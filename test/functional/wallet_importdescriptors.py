...
from test_framework.yody import convert_btc_address_to_yody, convert_btc_bech32_address_to_yody
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [convert_btc_address_to_yody(a) for a in ["2N7yv4p8G8yEaPddJxY41kPihnWvs39qCMf", "2MsHxyb2JS3pAySeNUsJ7mNnurtpeenDzLA"]] # hdkeypath=m/0'/0'/0' and 1'
        addresses += [convert_btc_bech32_address_to_yody(a) for a in ["bcrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7scl8gn", "bcrt1qfqeppuvj0ww98r6qghmdkj70tv8qpchehegrg8"]] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            convert_btc_bech32_address_to_yody('bcrt1qtmp74ayg7p24uslctssvjm06q5phz4yrxucgnv'), # m/0'/0'/0
            convert_btc_bech32_address_to_yody('bcrt1q8vprchan07gzagd5e6v9wd7azyucksq2xc76k8'), # m/0'/0'/1
            convert_btc_bech32_address_to_yody('bcrt1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjp9lulu'), # m/0'/0'/2
            convert_btc_bech32_address_to_yody('bcrt1qau64272ymawq26t90md6an0ps99qkrse58m640'), # m/0'/0'/3
            convert_btc_bech32_address_to_yody('bcrt1qsg97266hrh6cpmutqen8s4s962aryy77jp0fg0'), # m/0'/0'/4
        ]
        ...
        assert_equal(address, convert_btc_address_to_yody("mpA2Wh9dvZT7yfELq1UnrUmAoc5qCkMetg"))
        ...
        address = convert_btc_address_to_yody("2MuhcG52uHPknxDgmGPsV18jSHFBnnRgjPg")
        ...
        assert_equal(addr, convert_btc_bech32_address_to_yody('bcrt1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fq2czhy8')) # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32')
        assert_equal(change_addr, convert_btc_bech32_address_to_yody('bcrt1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lnsy44n8e'))
        ...
        assert_equal(addr, convert_btc_bech32_address_to_yody('bcrt1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqn6mvr9')) # Derived at m/84'/0'/0'/1
