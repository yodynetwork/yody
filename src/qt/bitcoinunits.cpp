...
static constexpr auto MAX_DIGITS_BTC = 17;
...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("YODY");
    case mBTC: return QString("mYODY");
    case uBTC: return QString::fromUtf8("μYODY (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Yodys");
    case mBTC: return QString("Milli-Yodys (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Yodys (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
QString BitcoinUnits::formatPrivacy(int unit, const CAmount& amount, SeparatorStyle separators, bool privacy)
{
    assert(amount >= 0);
    QString value;
    if (privacy) {
...
{
    return formatPrivacy(unit, amount, separators, privacy) + QString(" ") + shortName(unit);
}
